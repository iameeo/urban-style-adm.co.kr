...
public class MultipartUtility_SS {
	private static final Logger log = getLogger(MultipartUtility_SS.class.getName());
	...
	public MultipartUtility_SS(final URL url) throws IOException, NoSuchAlgorithmException, KeyManagementException {
